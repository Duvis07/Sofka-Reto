...
public class Ronda extends Pregunta{
    ...
    //Este mentodo se encarga de convertir lospuntos obtenidos en dinero
    ...
    //Este metodo da como  fianlizado el juego
    ...
    //Este metodo da la opcion al  participante para que se retire de forma voluntaria del juego
    public void retirada(){System.out.println("Te has retirado del juego, te llevas un total de "+ getPuntos()+ " Puntos");
    }
